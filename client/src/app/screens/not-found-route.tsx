...
export function NotFoundRoute() {
  return (
    <section class="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 class="mt-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">页面未找到</h2>
      <p class="mt-2 max-w-xs text-sm text-zinc-500 dark:text-zinc-400">您查找的页面不存在。</p>
      <a
        href="#/"
