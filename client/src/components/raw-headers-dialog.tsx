                ...
                <table class="w-full border-collapse text-sm">
                  <thead>
                    <tr class="border-b border-zinc-200 dark:border-zinc-800">
                      <th class="w-1/3 pb-2 text-left font-medium text-zinc-500 dark:text-zinc-400">
                        字段
                      </th>
                      <th class="pb-2 text-left font-medium text-zinc-500 dark:text-zinc-400">
                        值
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <For each={query.data?.headers}>
                      {(h) => (
                        <tr class="border-b border-zinc-100 last:border-b-0 dark:border-zinc-800/50">
                          ...
                          <td class="py-1.5 break-all text-zinc-900 dark:text-zinc-100">
                            {h.value}
                          </td>
                        </tr>
                      )}
